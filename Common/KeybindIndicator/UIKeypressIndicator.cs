...
internal class UIKeypressIndicator : UIElement
{
    ...
    internal UIKeypressIndicator() : base()
    {
        ...
        KeypressIndicatorLeft = this.AddElement(new UIImageFramed(ModContent.Request<Texture2D>($"{textureFolder}/KeypressIndicator"), new Rectangle(0, 0, 34, 70)).With(e =>
        {
            e.VAlign = 0.5f;
        ...
        KeypressIndicatorRight = this.AddElement(new UIImageFramed(ModContent.Request<Texture2D>($"{textureFolder}/KeypressIndicator"), new Rectangle(36, 0, 34, 70)).With(e =>
        {
            e.HAlign = 1;
            e.VAlign = 0.5f;
            e.Width = StyleDimension.FromPixels(34);
