...
internal abstract class Powerup : ModType
{
    ...
    internal virtual int? ProjectileType => null;
    internal virtual int? ItemType => null;
    ...
    /// <summary>
    /// The behavior of this Powerup when it exists in the world, e.g. movement behavior. Similar in concept to ModItem.Update.
    /// </summary>
    ...
    { }
    /// <summary>
    /// Any special effects this Powerup gives when consumed, e.g. dust or unrelated state changes.
    /// </summary>
    /// <param name="player">The player that consumed this Powerup</param>
    internal virtual void OnConsume(Player player) { }
    /// <summary>
    /// The effects this Powerup gives to the player that consumed it. This is run during ModItem.UpdateAccessory.
    /// </summary>
    /// <param name="player">The player that consumed this Powerup</param>
